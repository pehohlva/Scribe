...
QColor FopColor::foColor(const QString colorchunk,
                         FopColor::AlternateColor col) {
...
qreal FopInt(const QString datain) { return Unit(datain); }
