...
#define SCRIBEVERSION "3.0.0"

#define _PARSE_DEBUG_FOP_ 1
#define _DRAWMODUS_WEB_ 0

#define FOPIMAGEDIR QString("Pictures/")
...
#define _APPLICATIONS_NAME_                                                    \
  QString("MiniScribus Scribe version %1 ").arg(SCRIBEVERSION)

#define _NOTITLEONDOC_                                                         \
  QString("MiniScribus ver. %1 - Untitled Document").arg(SCRIBEVERSION)

#define NEWLAYERCOLORSET QColor("turquoise")

#define AbsoluteLayerRemoveHashID 87686

#define _APPSCACHE_ QString("%1/.scribe").arg(QDir::homePath())

#define _OOOV1FILE_ QString("%1/styleoo11.xsl").arg(_APPSCACHE_)
#define _OOOV2FILE_ QString("%1/styleoo24.xsl").arg(_APPSCACHE_)

#define _MASTERLINK_                                                           \
  QString("http://code.google.com/p/fop-miniscribus/") /* real txt palette */

#define _BREACKLINECOMMENT_                                                    \
  "Hack to replace br fop Empty paragraph version 1.001. Target to display "   \
  "similar to Apache fop"
